...
export default function LegalExpertLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profileError || profile?.role !== 'legal-expert') {
        await supabase.auth.signOut();
        throw new Error('Access denied. You do not have legal expert privileges.');
      }

      navigate('/legal-expert');
    } catch (err) {
      console.error('Legal expert login error:', err);
