        ...
        <div className="glass-white rounded-2xl p-8 md:p-10 shadow-2xl border border-[#FF9933]/20">
          ...
          {isSignedUp ? (
            ...
            >
              ...
              <p className="text-[#64748B] mb-6">Your educator account has been created. Redirecting to login...</p>
              <Link 
                to="/auth/educator/login"
                className="inline-block px-6 py-2 bg-[#FF9933] text-white rounded-lg hover:bg-[#E87F1F] transition-all"
              >
                Go to Login
              </Link>
            </motion.div>
