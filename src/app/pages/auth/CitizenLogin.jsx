...
export default function CitizenLogin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profileError || (profile?.role !== 'citizen' && profile?.role !== 'admin')) {
        // Admins can typically access citizen views too
        await supabase.auth.signOut();
        throw new Error('Access denied. You do not have citizen privileges.');
      }
