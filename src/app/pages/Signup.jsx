...
export default function Signup() {
  const portals = [
    {
      title: 'Educator',
      description: 'Join as teacher or content creator',
      icon: BookOpen,
      link: '/auth/educator/signup',
      color: 'from-[#FF9933] to-[#FFB366]',
    },
    {
      title: 'Legal Expert',
      description: 'Register as legal professional',
      icon: Scale,
      link: '/auth/legal-expert/signup',
      color: 'from-[#138808] to-[#1ea712]',
    },
    {
      title: 'Citizen',
      description: 'Sign up as learner',
      icon: Users,
      link: '/auth/citizen/signup',
      ...
      >
        ...
        <div className="glass-white rounded-2xl p-8 md:p-10 shadow-2xl border border-[#0A1F44]/10">
          ...
          <div className="text-center">
            <Link 
              to="/login"
              className="inline-flex items-center justify-center px-8 py-3 border-2 border-[#0A1F44] text-[#0A1F44] rounded-lg hover:bg-[#0A1F44] hover:text-white transition-all"
            >
              Sign In Instead
            </Link>
          </div>
